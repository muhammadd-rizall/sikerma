<?php
        ...
        $fiveYearsAgo = $currentYear - 5; // Menghitung 5 tahun terakhir
        
        $query_year = "
            SELECT YEAR(awal_kerjasama) AS Tahun, jenis_kerjasama, COUNT(*) AS jumlah 
            FROM tb_mou_moa 
            WHERE YEAR(awal_kerjasama) >= $fiveYearsAgo 
