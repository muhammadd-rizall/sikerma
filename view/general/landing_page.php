                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($landingPage = $result->fetch_assoc()) {
                                echo "<tr>
                                        <td>{$no}</td>
                                        <td>{$landingPage['Nama Mitra']}</td>
                                        <td>{$landingPage['Jenis Kerjasama']}</td>
                                        <td>{$landingPage['Jenis Kerjasama']}</td>
                                        <td>{$landingPage['Judul Kerjasama']}</td>
                                        <td>{$landingPage['Tanggal Awal']}</td>
                                        <td>{$landingPage['Tanggal Akhir']}</td>
                                        <td>{$landingPage['Status']}</td>
                                        <td>{$landingPage['email']}</td>
                                        <td>{$landingPage['Detail']}</td>                                      
                                    </tr>";
                                $no++;
                            }
                        } else {
